        ...
        <div className="rounded-xl bg-white p-8 shadow-xl">
          <div className="mb-6 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900">
              {requiresOtp ? 'Enter OTP' : 'Student Login'}
            </h2>
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-gray-900 shadow-sm focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500 placeholder:text-gray-400"
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    <input
                      ...
                      className="block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 pr-10 text-gray-900 shadow-sm focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500 placeholder:text-gray-400"
                      placeholder="••••••••"
                      style={{ color: '#171717' }}
                    />
                    <button
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-gray-900 shadow-sm focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500 text-center text-2xl tracking-widest placeholder:text-gray-400"
                    style={{ color: '#171717' }}
                    placeholder="------"
                    maxLength={6}
                  />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`text-sm ${resendCooldown > 0 ? 'text-gray-400 cursor-not-allowed' : 'text-green-600 hover:text-green-800'}`}
                  >
                    {resending ? (
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-500">
              New student?{' '}
              <Link href="/student-register" className="font-medium text-green-600 hover:text-green-700">
                Register here
              </Link>
            </p>
