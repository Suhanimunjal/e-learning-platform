...
const public_course_guard_1 = require("../common/guards/public-course.guard");
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.UseGuards)(optional_jwt_guard_1.OptionalJwtAuthGuard, public_course_guard_1.PublicCourseGuard),
