...
let AiController = class AiController {
    ...
    async gradeQuizAttempt(attemptId, req) {
        return this.aiService.gradeQuizAttempt(attemptId, req.user);
    }
    async getQuizGradingStatus(attemptId) {
...
__decorate([
    (0, common_1.Post)('grade-quiz/:attemptId'),
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.MANAGER, client_1.Role.TEACHER),
    ...
    __metadata("design:returntype", Promise)
], AiController.prototype, "gradeQuizAttempt", null);
__decorate([
    (0, common_1.Get)('grade-quiz/:attemptId/status'),
    __param(0, (0, common_1.Param)('attemptId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AiController.prototype, "getQuizGradingStatus", null);
__decorate([
