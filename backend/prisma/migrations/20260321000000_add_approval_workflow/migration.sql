...
-- 3. Create CourseStatus enum
CREATE TYPE "CourseStatus" AS ENUM ('PENDING_APPROVAL', 'APPROVED', 'REJECTED');
ALTER TABLE "Course" ADD COLUMN IF NOT EXISTS "status" "CourseStatus" DEFAULT 'PENDING_APPROVAL';
